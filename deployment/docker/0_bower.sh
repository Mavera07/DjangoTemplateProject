...
docker build -f $DIR/init/Dockerfile-init-bower -t djangotemplateproject_init_bower_i $DIR/../../
...
cp -r /var/lib/docker/volumes/djangotemplateproject_bower-volume/_data $DIR/../../resources/volumes/bower_components
